//! Dependencies: `serde`
//!
//! A 50×50 binary grid meant to be used to flag tiles in a room
//!
//! Has basic compression built in too for more compact serialization
...
impl BitRoomGrid {
    ...
    fn get_row_col(x: u16, y: u16) -> (usize, usize) {
        let row_size = ROW_SIZE * 8;
        let flat_ind = x as usize * ROWS + y as usize;
